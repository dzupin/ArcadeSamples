...
class MyApplication(arcade.Window):
    ...
    def setup(self):
        ...
        # Set up the player
        self.score = 0
        self.player_sprite = arcade.Sprite("images/female_idle.png", 0.5)
        ...
        for i in range(50):
            ...
            coin = Collectable("images/coinGold.png", SPRITE_SCALING)
            coin.width = 30
            coin.height = 30
    ...
    def update(self, delta_time):
        ...
        for coin in hit_list:
            ...
            if not coin.changed:
                # No? Then do so
                coin.texture = arcade.load_texture("images/coinSilver.png")
                coin.changed = True
                coin.width = 30
                coin.height = 30
                self.score += 1
