...
class MyApplication(arcade.Window):
    ...
    def level_1(self):
        for i in range(20):
            ...
            coin = arcade.Sprite("images/coinBronze.png", SPRITE_SCALING /1.5 )            # Position the coin
    ...
    def level_2(self):
        for i in range(30):
            ...
            # Create the coin instance
            coin = FallingCoin("images/coinSilver.png", SPRITE_SCALING / 2)
    ...
    def level_3(self):
        for i in range(30):
            ...
            # Create the coin instance
            coin = RisingCoin("images/coinGold.png", SPRITE_SCALING / 2)
